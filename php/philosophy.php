...
<p>Jappix is an XMPP web client. We think that making a better web is one of the most important thing. Therefore, we try to respect the web standards and try to use HTML5 and CSS3 as much as possible</p>
<p>The web is more and more social. One of Jappix’ goals is to foster communication. We don’t want a centralized web, that’s why you can manage your own Jappix node. We don’t want your data to be scattered all over the internet, that’s why we use XMPP, a universal protocol that helps you be closer!</p>
</article>
...
<p style="padding-left: 50px;">Want to help but you don't have any idea? No problem, you're in the right place! You can go to <a href="http://developer.jappix.org/0.9.1">our roadmap</a> and implement new features, or you can go to <a href="https://github.com/jappix/jappix/issues">our bugtracker</a> to fix bugs!</p>
